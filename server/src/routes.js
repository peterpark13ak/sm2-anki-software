...
router.get('/api/cards/tag', getUser, cards.findCardsByTag);
...
router.get('/api/decks/all', getUser, decks.findAllDecks);
router.get('/api/decks/tag', getUser, decks.findDecksByTag);
...
router.get('/api/users/all', users.findAllUsers);
