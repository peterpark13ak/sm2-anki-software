...
class Login extends Component {
    ...
    if (!errors.email && !errors.password) {
      api.loginUser(email, password).then(
        response => {
          ...
          cookie.set("plans", response.data.wp_membership_plans);
  ...
  handleError = error => {
    ...
    this.setState({ errors: { ...this.state.errors, form: message }, loading: false });
  };
          ...
          <div className="row">
            <div className="col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
              ...
              <Form error={!!errors.form}>
                ...
                {
                  loading === true ?
                    <Button onClick={this.onSubmit} type="submit" primary fluid disabled>
                      Authenticating and Loading datasets ...
                    </Button>
                  :
