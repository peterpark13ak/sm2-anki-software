...
import { Signup, Login, Logout, ReqAuth, ReqAdminAuth, ResetPassword } from "./auth";
import { Decks, DeckHome, DeckNew, DeckTagHome, AdminDecks } from "./decks";
        ...
        <div className="App">
          ...
          <div className="App-content py-5">
            ...
            <Switch>
              ...
              <Route exact path="/decks/all" component={ReqAdminAuth(AdminDecks)} />
              <Route exact path="/decks/new" component={ReqAuth(DeckNew)} />
              <Route exact path="/decks/:deckId" component={ReqAuth(DeckHome)} />
              <Route exact path="/decks/tag/:tag" component={ReqAuth(DeckTagHome)} />
              ...
              <Route exact path="/memberships" component={ReqAdminAuth(Memberships)} />
