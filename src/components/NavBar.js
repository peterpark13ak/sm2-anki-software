    ...
    return (
      ...
      >
        <div className="container">
          <Link className="navbar-brand" to={!authenticated ? "/" : (email === ADMIN_ID ? "/decks/all" : "/decks")}>
            Pensieve
          </Link>
          {email === ADMIN_ID &&
            <React.Fragment>
              <Link className="navbar-brand" style={{marginLeft: 20}} to={!authenticated ? "/" : "/decks"}>
                Default Decks
              </Link>
              <Link className="navbar-brand" style={{marginLeft: 20}} to={!authenticated ? "/" : "/memberships"}>
                Membership Plans
              </Link>
            </React.Fragment>
          }
